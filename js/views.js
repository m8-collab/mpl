...
function viewAbout(){
  return `
  <section style="padding-top:44px;border-bottom:none;">
    <div class="eyebrow">ABOUT THE LEAGUE</div>
    <h2 style="margin-top:6px;font-size:2.1rem;">Mtwapa Premier CBO</h2>
    
    <div style="max-width:820px;margin-top:28px;">
      <div style="background:var(--pitch-2);border:1px solid var(--line);padding:28px 32px;margin-bottom:32px;border-left:6px solid var(--gold);">
        <p style="font-size:1.05rem;color:var(--ivory);line-height:1.7;margin-bottom:12px;font-weight:500;">
          A group of community development in sports, talents, arts, health, education, 
          clean environment and economic and social transformation for a sustainable future.
        </p>
        <div style="display:flex;align-items:center;gap:16px;flex-wrap:wrap;padding-top:14px;border-top:1px solid var(--line);">
          <span style="font-family:'IBM Plex Mono';font-size:.7rem;color:var(--steel);letter-spacing:.06em;text-transform:uppercase;">Established</span>
          <span style="font-family:'Oswald';font-size:1.1rem;color:var(--gold);">April 16th, 2026</span>
        </div>
      </div>
    </div>

    <h3 style="font-size:1.4rem;margin-top:40px;">Purpose</h3>
    <p style="max-width:760px;color:var(--ivory-dim);line-height:1.8;margin-top:10px;font-size:.98rem;">
      To organize and promote sporting activities among sportsmen and the community at large. 
      Becoming a cornerstone in establishing sports talents events, academies and stadiums 
      for the purpose of running sporting activities. Attaining sporting resources to implement 
      sports tournaments, local leagues, awards and rewarding.
    </p>

    <h3 style="font-size:1.4rem;margin-top:44px;">Objectives</h3>
    <ul style="max-width:760px;color:var(--ivory-dim);line-height:1.8;margin-top:12px;padding:0;list-style:none;">
      <li style="padding:8px 0;border-bottom:1px solid var(--line);display:flex;align-items:flex-start;gap:12px;">
        <span style="color:var(--gold);font-size:1.2rem;flex-shrink:0;">▸</span>
        Promote unity and inter-personal relationship between members
      </li>
      <li style="padding:8px 0;border-bottom:1px solid var(--line);display:flex;align-items:flex-start;gap:12px;">
        <span style="color:var(--gold);font-size:1.2rem;flex-shrink:0;">▸</span>
        Promote talents in sports
      </li>
      <li style="padding:8px 0;border-bottom:1px solid var(--line);display:flex;align-items:flex-start;gap:12px;">
        <span style="color:var(--gold);font-size:1.2rem;flex-shrink:0;">▸</span>
        Venture into sporting activities through organizing sports activities and competition to promote youth talents
      </li>
      <li style="padding:8px 0;border-bottom:1px solid var(--line);display:flex;align-items:flex-start;gap:12px;">
        <span style="color:var(--gold);font-size:1.2rem;flex-shrink:0;">▸</span>
        Provide a chance to youth achieve educational goals through sourcing and providing educational incentives and scholarships
      </li>
      <li style="padding:8px 0;border-bottom:1px solid var(--line);display:flex;align-items:flex-start;gap:12px;">
        <span style="color:var(--gold);font-size:1.2rem;flex-shrink:0;">▸</span>
        Provide sports scholarships to talented youth by offering educational opportunities through negotiation with institutions
      </li>
      <li style="padding:8px 0;border-bottom:1px solid var(--line);display:flex;align-items:flex-start;gap:12px;">
        <span style="color:var(--gold);font-size:1.2rem;flex-shrink:0;">▸</span>
        Offer support to groups and youth in developing film and music projects
      </li>
      <li style="padding:8px 0;border-bottom:1px solid var(--line);display:flex;align-items:flex-start;gap:12px;">
        <span style="color:var(--gold);font-size:1.2rem;flex-shrink:0;">▸</span>
        Organize competition and awards among sporting clubs
      </li>
      <li style="padding:8px 0;border-bottom:1px solid var(--line);display:flex;align-items:flex-start;gap:12px;">
        <span style="color:var(--gold);font-size:1.2rem;flex-shrink:0;">▸</span>
        Organize football, bicycle race, swimming and other sports competitions to promote, reward, expose and source financial assistance
      </li>
      <li style="padding:8px 0;border-bottom:1px solid var(--line);display:flex;align-items:flex-start;gap:12px;">
        <span style="color:var(--gold);font-size:1.2rem;flex-shrink:0;">▸</span>
        Collaborate with business stakeholders, community leaders and NGOs in sourcing support for sports and talents
      </li>
      <li style="padding:8px 0;border-bottom:1px solid var(--line);display:flex;align-items:flex-start;gap:12px;">
        <span style="color:var(--gold);font-size:1.2rem;flex-shrink:0;">▸</span>
        Develop sports to be economically sustainable to members and the community at large
      </li>
      <li style="padding:8px 0;border-bottom:1px solid var(--line);display:flex;align-items:flex-start;gap:12px;">
        <span style="color:var(--gold);font-size:1.2rem;flex-shrink:0;">▸</span>
        Create awareness on health, environment and economic development through sports and talents activities
      </li>
      <li style="padding:8px 0;border-bottom:1px solid var(--line);display:flex;align-items:flex-start;gap:12px;">
        <span style="color:var(--gold);font-size:1.2rem;flex-shrink:0;">▸</span>
        Enhance oneness, sense of belonging, integrity and respect to the law and to one another
      </li>
      <li style="padding:8px 0;border-bottom:1px solid var(--line);display:flex;align-items:flex-start;gap:12px;">
        <span style="color:var(--gold);font-size:1.2rem;flex-shrink:0;">▸</span>
        Initiate socio-economic activities and offer education scholarships to needy, bright students, poor, orphans and talented youth
      </li>
      <li style="padding:8px 0;border-bottom:1px solid var(--line);display:flex;align-items:flex-start;gap:12px;">
        <span style="color:var(--gold);font-size:1.2rem;flex-shrink:0;">▸</span>
        Encourage income generating investment projects
      </li>
      <li style="padding:8px 0;border-bottom:1px solid var(--line);display:flex;align-items:flex-start;gap:12px;">
        <span style="color:var(--gold);font-size:1.2rem;flex-shrink:0;">▸</span>
        Develop effective and efficient monitoring and evaluation mechanisms in all activities and projects
      </li>
      <li style="padding:8px 0;border-bottom:1px solid var(--line);display:flex;align-items:flex-start;gap:12px;">
        <span style="color:var(--gold);font-size:1.2rem;flex-shrink:0;">▸</span>
        Encourage members interaction, share experiences and challenges in life
      </li>
      <li style="padding:8px 0;border-bottom:1px solid var(--line);display:flex;align-items:flex-start;gap:12px;">
        <span style="color:var(--gold);font-size:1.2rem;flex-shrink:0;">▸</span>
        Provide financial support to members through a financial support to establish income generating projects
      </li>
      <li style="padding:8px 0;display:flex;align-items:flex-start;gap:12px;">
        <span style="color:var(--gold);font-size:1.2rem;flex-shrink:0;">▸</span>
        Provide a sporting chance to the community through programs such as Mtwapa Premier soccer, Copsa Talents for school, athletics and bicycle race
      </li>
    </ul>

    <h3 style="font-size:1.4rem;margin-top:48px;">Contact Information</h3>
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;margin-top:14px;max-width:760px;">
      <div style="background:var(--pitch-2);border:1px solid var(--line);padding:18px 20px;">
        <p style="font-family:'IBM Plex Mono';font-size:.6rem;color:var(--steel);letter-spacing:.08em;text-transform:uppercase;margin:0 0 4px 0;">Location</p>
        <p style="font-size:.85rem;color:var(--ivory-dim);margin:0;">Starlight Building, Mtaani-Maweni, Mtwapa</p>
        <p style="font-size:.75rem;color:var(--steel);margin:4px 0 0 0;">Along Mtwapa Luxury Road</p>
      </div>
      <div style="background:var(--pitch-2);border:1px solid var(--line);padding:18px 20px;">
        <p style="font-family:'IBM Plex Mono';font-size:.6rem;color:var(--steel);letter-spacing:.08em;text-transform:uppercase;margin:0 0 4px 0;">Postal Address</p>
        <p style="font-size:.85rem;color:var(--ivory-dim);margin:0;">P.O Box 726-80109</p>
        <p style="font-size:.75rem;color:var(--steel);margin:4px 0 0 0;">Mtwapa, Kenya</p>
      </div>
      <div style="background:var(--pitch-2);border:1px solid var(--line);padding:18px 20px;">
        <p style="font-family:'IBM Plex Mono';font-size:.6rem;color:var(--steel);letter-spacing:.08em;text-transform:uppercase;margin:0 0 4px 0;">Email</p>
        <p style="font-size:.85rem;color:var(--ivory-dim);margin:0;word-break:break-all;">mtwapapremier26@gmail.com</p>
      </div>
      <div style="background:var(--pitch-2);border:1px solid var(--line);padding:18px 20px;">
        <p style="font-family:'IBM Plex Mono';font-size:.6rem;color:var(--steel);letter-spacing:.08em;text-transform:uppercase;margin:0 0 4px 0;">Telephone</p>
        <p style="font-size:.85rem;color:var(--ivory-dim);margin:0;">0799 669 040</p>
        <p style="font-size:.75rem;color:var(--steel);margin:2px 0 0 0;">0711 413 416 / 0722 370 130</p>
      </div>
    </div>

    <div style="margin-top:32px;padding:24px 28px;background:rgba(201,162,39,0.06);border:1px solid var(--line);max-width:760px;">
      <p style="font-family:'IBM Plex Mono';font-size:.7rem;color:var(--gold);letter-spacing:.06em;text-transform:uppercase;margin:0 0 6px 0;">
        Mtwapa Premier CBO
      </p>
      <p style="font-size:.85rem;color:var(--ivory-dim);margin:0;line-height:1.6;">
        A Group of Community Development in Sports, Talents, Arts, Health, Education, 
        Clean Environment and Economic and Social Transformation for a Sustainable Future.
      </p>
    </div>
